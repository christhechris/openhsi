# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/atmos.ipynb.

# %% auto #0
__all__ = ['Model6SV', 'remap', 'SpectralLibrary', 'SpectralMatcher', 'ELC', 'DataCubeViewer']

# %% ../nbs/api/atmos.ipynb #dcdf89e3
...
# %% ../nbs/api/atmos.ipynb #5dd2c3d0
from .data import *

# %% ../nbs/api/atmos.ipynb #8a977d5f
class Model6SV(object):
    ...
    def show(self, plot_lib:str="bokeh", # choose between the "bokeh" or "matplotlib" plotting backend
            ) -> hv.element.chart.Curve: # output plot
...
class SpectralLibrary():
    ...
    def show(self,plot_lib:str="bokeh", # chose between "bokeh" or "matplotlib" plotting backend
             topk:pd.DataFrame=None, # DataFrame of top k matches
             radiance_6SV:np.array=None, # if included, plot in reflectance rather than radiance
            ) -> hv.element.chart.Curve: # labelled plot
...
class SpectralMatcher(SpectralLibrary):
    ...
    def interp(self,wavelengths:np.array, # array of wavelengths in nm
              ):
    ...
    def show(self,plot_lib:str="bokeh", # choose between "bokeh" or "matplotlib" plotting backends
             is_rad:bool=False, # choose to show in radiance
            ) -> hv.element.chart.Curve: # labelled plot
    ...
    def topk_spectra(self,spectrum:np.array, # spectrum array to compare against the loaded spectral library
                     k:int=5,          # number of top matches to return
                     refine=True,      # minimise the amplitude differences once similar spectra are found 
                    ) -> pd.DataFrame: # results sorted from best match to worst
