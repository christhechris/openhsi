...
# %% auto #0
__all__ = ['WebCamera', 'switched_camera', 'FlirCameraBase', 'FlirCamera', 'SharedFlirCamera', 'LucidCameraBase', 'LucidCamera', 'SharedLucidCamera', 'SimulatedCameraBase', 'SimulatedCamera', 'SharedSimulatedCamera', 'XimeaCameraBase', 'XimeaCamera', 'SharedXimeaCamera', 'LucidCameraBase', 'LucidCamera', 'SharedLucidCamera']
