# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/geometry.ipynb.

# %% auto #0
__all__ = []

# %% ../nbs/api/geometry.ipynb #c8014a2d
...
# %% ../nbs/api/geometry.ipynb #db5cb9af
from .data import *
from .capture import ProcessDatacube

# %% ../nbs/api/geometry.ipynb #b119e847
class GeorectifyDatacube(ProcessDatacube):
    ...
    def __init__(self, fname:str,   # path to a datacube
        ...
        if DEM_path:
        warnings.warn(
            "DEM support is not yet implemented. The DEM_path argument will be ignored.",
